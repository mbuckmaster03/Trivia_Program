...
class HistoryQuestions(Screen):
    def __init__(self):
        ...
        def setup(self, answers):
            ...
            #Buttons
            self.btn_next = tk.Button(self,text = "Next", font = BUTTON_FONT, command = self.next_q)
...
if __name__ == "__main__":
    ...
    screens = [MainMenu(), History(), Geography(), Music(), Games(), Random(), HistoryQuestions()]
